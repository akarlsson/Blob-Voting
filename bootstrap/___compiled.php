...
class Application extends Container implements HttpKernelInterface, ResponsePreparerInterface
{
    ...
    {
        return '/var/vhosts/grafikant.com/fb/blob/vendor/laravel/framework/src/Illuminate/Foundation' . '/start.php';
    }
    /**
...
class PrettyPageHandler extends Handler
{
    ...
    public function handle()
    {
        ...
        if (!($resources = $this->getResourcesPath())) {
            $resources = '/var/vhosts/grafikant.com/fb/blob/vendor/filp/whoops/src/Whoops/Handler' . '/../Resources';
        }
