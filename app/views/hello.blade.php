...
<html xmlns:fb="http://www.facebook.com/2008/fbml">
  <head>
	...
	<link rel="stylesheet" type="text/css" href="{{ Request::root() }}/css/main.css?123612312321212511">
  ...
  <div class="header">
    ...
    <div style="position:relative;float:left;text-align:center;width:100%;margin: 20px auto 50px auto;"><div><a href="{{ Request::root() }}/items/create" class="votebutton">Jetzt bewerben</a></div></div>
    @endif
  </div>
		 ...
		 if (strrpos($par,"vote") !== false) {
		  ...
		  if (strrpos($par,"detail") !== false) {
			...
			?> 
				<p>&nbsp;</p>
				<p>
                <div class="imgholder"  style="height:400px;background-image:url({{ Request::root() }}/photos/{{ $item->image }});background-repeat:no-repeat;background-position: center bottom;background-size: 100%;">
				<h1>{{ $item->name }}</h1>
                    <div class="voting">
                     {{ $votes }}<br />
